...
export const TESTIMONIALS = [
  // São José dos Campos
  {
    ...
    neighborhood: "Bosque dos Eucaliptos",
    rating: 5,
    service: "Roupas do dia a dia",
    text: "Uso a A7 há quase um ano e não consigo imaginar minha semana sem eles. Roupas chegam dobradas, perfumadas e sem uma ruga. O motoboy é sempre pontual e super simpático.",
    verified: true,
  },
  {
    id: 2,
    ...
    rating: 5,
    service: "Edredons",
    text: "Mandei três edredons que estavam guardados desde o inverno passado. Voltaram como se fossem novos — macios, sem nenhum cheiro de mofo. Minha filha tem rinite e a diferença foi imediata.",
    verified: true,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    neighborhood: "Cidade Morumbi",
    rating: 5,
    service: "Roupas sociais",
    text: "Trabalho com reuniões o tempo todo e preciso de ternos sempre impecáveis. A A7 virou minha parceira. Programo a coleta pelo WhatsApp em dois minutos e recebo tudo passado na perfeição.",
    verified: true,
  },
  {
    id: 5,
    ...
    rating: 5,
    service: "Uniformes corporativos",
    text: "Terceirizei a lavagem dos uniformes do meu salão para a A7. Equipe sempre apresentável, sem eu precisar gerenciar nada. Cobranças no CNPJ, nota fiscal, tudo certinho.",
    verified: true,
  },
  // Jacareí
  {
  ...
  // Taubaté
  {
    ...
    rating: 5,
    service: "Roupas do dia a dia",
    text: "Moro em Taubaté e não sabia que a A7 atendia aqui. Descobri pelo Google e já fiz três pedidos. Prazo de 48 horas cumprido sempre. Roupas chegam embaladas individualmente, parece roupa de hotel.",
    verified: true,
  },
  {
    id: 9,
    ...
    rating: 5,
    service: "Uniformes corporativos",
    text: "Tenho uma equipe de 12 pessoas e a lavagem dos uniformes virava bagunça. Com a A7, coleta toda segunda e entrega na quarta. Equipe padronizada, custo fixo, zero dor de cabeça.",
    verified: true,
  },
  // Manaus
  {
  ...
  // São Paulo
  {
    ...
    rating: 5,
    service: "Roupas delicadas",
    text: "Moro em São Paulo e fiquei com receio do delivery, mas superou todas as expectativas. Embalagem cuidadosa, prazo cumprido, e as peças voltaram sem nenhum dano. Já é rotina na minha casa.",
    verified: true,
  },
  // Mogi das Cruzes
  {
    ...
    neighborhood: "Centro",
    rating: 5,
    service: "Tênis e roupas",
    text: "Não esperava encontrar um serviço assim em Mogi. Agendei pelo WhatsApp, coleta foi no dia seguinte, entrega em 48h. Tênis e roupas impecáveis. Preço justo e sem enrolação.",
    verified: true,
  },
];
