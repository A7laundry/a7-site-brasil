...
const LANDING_PAGES = [
  // BLOCO A — Por Serviço
  { id: "LP-01", nome: "Higienização de Edredons", url: "/higienizacao-edredom", tipo: "SRV", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Saúde & Higiene" },
  { id: "LP-02", nome: "Limpeza de Tênis", url: "/tenis", tipo: "SRV", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Tênis" },
  { id: "LP-03", nome: "Limpeza de Tapetes", url: "/tapetes", tipo: "SRV", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Tapetes" },
  { id: "LP-04", nome: "Higienização de Sofás", url: "/sofas", tipo: "SRV", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Casa" },
  { id: "LP-05", nome: "Higienização de Cortinas", url: "/cortinas", tipo: "SRV", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Saúde & Higiene" },
  { id: "LP-06", nome: "Remoção de Manchas", url: "/remocao-manchas", tipo: "SRV", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Manchas" },
  { id: "LP-07", nome: "Roupas Delicadas", url: "/roupas-delicadas", tipo: "SRV", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Roupas Especiais" },
  { id: "LP-08", nome: "Lavagem do Dia a Dia", url: "/lavagem-roupas", tipo: "SRV", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Dia a Dia" },
  { id: "LP-09", nome: "Plano Mensal", url: "/plano-mensal", tipo: "OFT", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Dia a Dia" },
  { id: "LP-10", nome: "Couro e Peças Especiais", url: "/couro-pecas-especiais", tipo: "SRV", prioridade: "P2", status: "Publicado", responsavel: "Dev", cluster: "Roupas Especiais" },
  // BLOCO B — Por Persona
  { id: "LP-11", nome: "Para Casais", url: "/para-casais", tipo: "PER", prioridade: "P0", status: "Publicado", responsavel: "Design", cluster: "Dia a Dia" },
  { id: "LP-12", nome: "Para Mães com Filhos", url: "/para-maes", tipo: "PER", prioridade: "P0", status: "Publicado", responsavel: "Design", cluster: "Saúde & Higiene" },
  { id: "LP-13", nome: "Para Executivos", url: "/para-executivos", tipo: "PER", prioridade: "P1", status: "Publicado", responsavel: "Design", cluster: "Roupas Especiais" },
  { id: "LP-14", nome: "Para Alérgicos", url: "/para-alergicos", tipo: "PER", prioridade: "P0", status: "Publicado", responsavel: "Design", cluster: "Saúde & Higiene" },
  { id: "LP-15", nome: "Para Hosts de Airbnb", url: "/airbnb", tipo: "PER", prioridade: "P1", status: "Publicado", responsavel: "Design", cluster: "B2B" },
  { id: "LP-16", nome: "Premium Concierge", url: "/premium", tipo: "PER", prioridade: "P2", status: "Publicado", responsavel: "Design", cluster: "Roupas Especiais" },
  { id: "LP-17", nome: "Lavanderia Sustentável", url: "/sustentavel", tipo: "PER", prioridade: "P2", status: "Publicado", responsavel: "Design", cluster: "Sustentabilidade" },
  // BLOCO C — Por Nicho B2B
  { id: "LP-18", nome: "Empresarial (Hub B2B)", url: "/empresarial", tipo: "NIC", prioridade: "P0", status: "Publicado", responsavel: "Comercial", cluster: "B2B" },
  { id: "LP-19", nome: "Para Restaurantes", url: "/restaurantes", tipo: "NIC", prioridade: "P0", status: "Publicado", responsavel: "Comercial", cluster: "B2B" },
  { id: "LP-20", nome: "Para Hotéis e Pousadas", url: "/hotelaria", tipo: "NIC", prioridade: "P0", status: "Publicado", responsavel: "Comercial", cluster: "B2B" },
  { id: "LP-21", nome: "Uniformes Corporativos", url: "/uniformes", tipo: "NIC", prioridade: "P1", status: "Publicado", responsavel: "Comercial", cluster: "B2B" },
  { id: "LP-22", nome: "Para Condomínios", url: "/condominios", tipo: "NIC", prioridade: "P2", status: "Publicado", responsavel: "Comercial", cluster: "B2B" },
  // BLOCO D — Por Cidade
  ...
  { id: "LP-24", nome: "Taubaté", url: "/taubate", tipo: "CID", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Local" },
  { id: "LP-25", nome: "Jacareí", url: "/jacarei", tipo: "CID", prioridade: "P1", status: "Publicado", responsavel: "Dev", cluster: "Local" },
  { id: "LP-26", nome: "Lorena e Guaratinguetá", url: "/lorena-guaratingueta", tipo: "CID", prioridade: "P2", status: "Publicado", responsavel: "Dev", cluster: "Local" },
  { id: "LP-27", nome: "Vale do Paraíba (Hub)", url: "/vale-do-paraiba", tipo: "CID", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Local" },
  // BLOCO E — Por Decisão
  { id: "LP-28", nome: "Preços e Planos", url: "/precos", tipo: "DOR", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Decisão" },
  { id: "LP-29", nome: "Como Funciona", url: "/como-funciona", tipo: "DOR", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Decisão" },
  { id: "LP-30", nome: "Lavanderia ou em Casa?", url: "/lavanderia-ou-lavar-em-casa", tipo: "DOR", prioridade: "P0", status: "Publicado", responsavel: "Dev", cluster: "Decisão" },
];
...
const EXTERNAL_LINKS = [
  ...
  { href: "/marketing-os", label: "Marketing OS", icone: "🧠", desc: "Clusters · Funil · Personas · Roadmap · Classificador" },
];
