      ...
      <section className="py-16 bg-blue-900/40">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { bairro: "Bosque dos Eucaliptos", endereco: "Av. Andrômeda, 3115", cep: "12233-000", horario: "Seg–Sex 08–18h · Sáb 08–13h", phone: "(12) 3917-4807", wa: "551239174807" },
              { bairro: "Urbanova II", endereco: "Av. Shishima Hifumi, 2.200", cep: "12244-000", horario: "Seg–Sex 08–18h · Sáb 08–13h", phone: "(12) 3346-6490", wa: "551233466490" },
              { bairro: "Jardim São Dimas", endereco: "Av. Nove de Julho, 242", cep: "12243-000", horario: "Seg–Sex 09–18h · Sáb 09–13h", phone: "(12) 98844-0266", wa: "5512988440266" },
              { bairro: "Cidade Morumbi", endereco: "R. Gisele Martins, 441", cep: "12236-500", horario: "Aberto 24 horas", phone: "(12) 3939-7543", wa: "551239397543" },
              { bairro: "Jardim Morumbi", endereco: "Av. Benedito Bento, 717", cep: "12200-000", horario: "Seg–Sex 08–19h · Sáb 08–15h", phone: "(12) 3307-5748", wa: "551233075748" },
            ].map((u) => (
              <div key={u.bairro} className="bg-blue-900/50 border border-blue-800 rounded-xl p-5 hover:border-blue-500 transition-colors">
